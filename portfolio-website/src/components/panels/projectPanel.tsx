...
export const ProjectPanel: FC = () => {
    return (
    <div id="projects" className="min-h-screen bg-slate-800">
        <div className="container py-[30%] md:py-[10%]">
            ...
            <div className="grid grid-flow-row gap-2 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 py-4">
                <Projects/>
            </div>
